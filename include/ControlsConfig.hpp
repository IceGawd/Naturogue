...
struct ControlsConfig {
	...
	vector<SDL_Scancode> okay = {SDL_SCANCODE_E, SDL_SCANCODE_Z, SDL_SCANCODE_RETURN, SDL_SCANCODE_SPACE};
	vector<SDL_Scancode> back = {SDL_SCANCODE_Q, SDL_SCANCODE_X, SDL_SCANCODE_BACKSPACE, SDL_SCANCODE_ESCAPE};
};